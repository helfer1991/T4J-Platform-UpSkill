...
public class ProcessoSeriacaoTest {
    ...
    public void testEquals() {
        ...
        Date dtRealizacao = Date.valueOf("2020-12-31");
        List<Colaborador> lstColab = new ArrayList<>();
        lstColab.add(new Colaborador("JoseBalelas", "918273645", "josebalelas@mindera.pt"));
        ...
        ArrayList<Classificacao> lstClass = new ArrayList<>();
        lstClass.add(new Classificacao(1, Date.valueOf("2020-01-02"), cand));
        Object obj = new ProcessoSeriacao(dtRealizacao, c, anun, lstColab, lstClass);
        ProcessoSeriacao instance = new ProcessoSeriacao(dtRealizacao, c, anun, lstColab, lstClass);
