...
public class AnuncioTest {
    ...
    public void testEquals() {
        ...
        Anuncio instance = new Anuncio(dtInicioP, dtFimP, dtInicioC, dtFimC, dtInicioS, dtFimS, taf, c, reg);        
        Object o = new Anuncio(dtInicioP, dtFimP, dtInicioC, dtFimC, dtInicioS, dtFimS, taf, c, reg);   
