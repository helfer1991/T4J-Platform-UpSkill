...
public class CandidaturaTest {
    ...
    public void testEquals() {
        ...
        Object o = new Candidatura(anun, Date.valueOf("2020-12-12"), 12, 4, "ddddddddddddddd", "dddddddddddddddd", free);
        Candidatura instance = new Candidatura(anun, Date.valueOf("2020-12-12"), 12, 4, "ddddddddddddddd", "dddddddddddddddd", free);
